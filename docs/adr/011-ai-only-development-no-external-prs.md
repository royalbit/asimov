...
1. **PRs require human code review** - but the RoyalBit Asimov model removes humans from code-level decisions
...
**RoyalBit Asimov projects use AI-Only Development. External PRs are not accepted.**
      ...
      - uses: actions/github-script@v7
        with:
          script: |
            ...
            This project uses the **RoyalBit Asimov AI-Only Development Model** ([ADR-011](docs/adr/011-ai-only-development-no-external-prs.md)).
...
This project uses the **RoyalBit Asimov AI-Only Development Model**.
...
This project is developed by an autonomous AI following the RoyalBit Asimov.
