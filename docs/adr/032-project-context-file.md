...
```
cli/src/templates/
├── project-rust.yaml.tpl
├── project-python.yaml.tpl
├── project-node.yaml.tpl
├── project-go.yaml.tpl
├── project-flutter.yaml.tpl
├── project-docs.yaml.tpl
└── project-generic.yaml.tpl
```
...
```
.asimov/
├── roadmap.yaml      # WHAT to build (milestones) - preserved
└── project.yaml      # HOW to build (project context) - NEW
```
