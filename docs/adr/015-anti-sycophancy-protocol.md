...
Add **ANTI-SYCOPHANCY** as a core principle (Priority 1.5) in the RoyalBit Asimov, implemented via:
...
- Aligns with RoyalBit Asimov's "truth over plausibility" philosophy
...
- Does not affect models outside RoyalBit Asimov contexts
