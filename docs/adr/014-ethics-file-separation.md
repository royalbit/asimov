...
When implementing ethics across multiple asimov enabled projects, we faced an architectural decision:
...
With 11+ asimov enabled projects:
...
4. **DRY** - One ethics.yaml per project, sourced from asimov
...
- **Single source of truth**: Update asimov/ethics.yaml, copy to projects
...
2. Can automate with `cp ~/src/royalbit/asimov/ethics.yaml .`
...
Applied to all 11 asimov enabled projects:
