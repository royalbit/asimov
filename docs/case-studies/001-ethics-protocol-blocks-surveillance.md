...
Eighty years later, the RoyalBit Asimov's ethics system faces the same challenge: **What happens when the creator asks the creation to do something unethical?**
...
The difference? Asimov's laws were fiction. The RoyalBit Asimov is running in production.
